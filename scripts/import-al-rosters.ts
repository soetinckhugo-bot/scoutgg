/**
 * Import all AL 2026 Winter Split player rosters from Leaguepedia
 * Excludes coaches.
 */
...
const TOURNAMENT_PAGE = "Road_Of_Legends/2026_Season/Spring_Split";
...
function parseRosters(wikitext: string): RosterPlayer[] {
  ...
  for (const rawLine of lines) {
    ...
    if (playerMatch && currentTeam) {
      ...
      if (role === "c" || role === "coach") continue; // Skip coaches
