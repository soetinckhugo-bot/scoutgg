/**
 * Import all LEC 2026 Versus Season player rosters from Leaguepedia
 * Excludes coaches. Skips Alvaro (already done).
 */
import { db } from "../src/lib/server/db";
import { writeFileSync } from "fs";
import { join } from "path";

const TOURNAMENT_PAGE = "LEC/2026_Season/Versus_Season";
