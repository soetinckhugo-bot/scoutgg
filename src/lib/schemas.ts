...
export const PlayerCreateSchema = z.object({
  ...
  agentTwitterUrl: z.string().url().optional().nullable(),
  twitchUrl: z.string().url().optional().nullable(),
  riotId: z.string().max(100).optional().nullable(),
  photoUrl: z.string().max(500).optional().nullable(),
  bio: z.string().max(5000).optional().nullable(),
  isFeatured: z.boolean().optional(),
  hasPlayedInMajorLeague: z.boolean().optional(),
  peakElo2Years: z.number().int().min(0).optional().nullable(),
  bestProResult: z.string().max(100).optional().nullable(),
  eyeTestRating: z.number().min(0).max(5).optional().nullable(),
...
export const PlayerUpdateSchema = z.object({
  ...
  tier: z.enum(["S+", "S", "A+", "A", "B+", "B", "C", "1", "2", "3", "4", "5"]).optional().nullable(),
...
export const ProStatsUpdateSchema = z.object({
  ...
  winRate: z.number().optional().nullable(),
});
