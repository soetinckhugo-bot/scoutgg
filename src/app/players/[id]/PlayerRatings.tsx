            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="text-3xl font-bold text-text-heading">
                  ...
                  <span className="text-lg text-text-body font-normal">
                    /5
                  </span>
                </div>
              ...
              <div className="text-right space-y-1">
                {ATTRIBUTES.map((attr) => (
                  <div key={attr.key} className="flex items-center gap-2">
                    <span className="text-xs text-text-body w-16 text-right">
                      {attr.label}
                    </span>
                    <StarDisplay
                      value={
                    ...
                    />
                    <span className="text-xs font-medium text-text-heading w-6">
