  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Add Player */}
        <div className="rounded-lg border border-border mb-6 bg-card">
          <div className="p-4">
            ...
            {columns.map((column) => (
              <div key={column.id}>
                ...
                >
                  ...
                  <Badge
                    variant="secondary"
                    className="text-xs h-4 bg-surface-hover"
                  >
                    ...
                    <div
                      ...
                      className={`min-h-[200px] rounded-lg border-2 border-dashed p-2 transition-colors ${
                        snapshot.isDraggingOver
                          ? "border-accent bg-blue-50/50 bg-blue-500/10"
                          : "border-border"
                      }`}
                    >
                      {column.players.map((player, index) => (
                        ...
                        >
                          {(provided, snapshot) => (
                            ...
                            >
                              <div className="rounded-lg border border-border hover:shadow-sm transition-shadow bg-card">
                                <div className="p-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="flex items-center gap-2">
                                        <Link
                                          ...
                                          className="font-medium text-sm text-text-heading hover:text-primary-accent truncate"
                                        >
                                          {player.pseudo}
                                        </Link>
                                        <Badge
                                      ...
                                      <div className="text-xs text-text-body">
                                        ...
                                        {player.prospectScore && (
                                          <span className="ml-1 text-primary-accent">
