    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <Card className="mb-8 border-border">
        <CardContent className="p-6">
          <h2 className="text-2xl font-bold text-text-heading mb-4">Our Mission</h2>
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-8">
        <Card className="border-border">
          <CardContent className="p-4 text-center">
            <Users className="h-8 w-8 text-primary-accent mx-auto mb-3" />
            <h3 className="font-semibold text-text-heading mb-2">Player Profiles</h3>
        ...
        <Card className="border-border">
          <CardContent className="p-4 text-center">
            <Star className="h-8 w-8 text-primary-accent mx-auto mb-3" />
            <h3 className="font-semibold text-text-heading mb-2">Scouting Reports</h3>
            <p className="text-sm text-text-body">
        ...
        <Card className="border-border">
          <CardContent className="p-4 text-center">
            <TrendingUp className="h-8 w-8 text-primary-accent mx-auto mb-3" />
            <h3 className="font-semibold text-text-heading mb-2">Data Insights</h3>
            <p className="text-sm text-text-body">
      ...
      <Card className="mb-8 border-border">
        <CardContent className="p-6">
          <h2 className="text-2xl font-bold text-text-heading mb-4">The Scout Behind LeagueScout</h2>
          <div className="flex flex-col md:flex-row gap-6">
            <div className="w-24 h-24 rounded-full bg-primary-accent flex items-center justify-center text-3xl font-bold text-text-heading shrink-0 mx-auto md:mx-0">
              S
            </div>
            <div>
              <p className="text-text-body leading-relaxed">
              ...
              <div className="flex items-center gap-4 mt-4">
                <a
                  ...
                  className="text-primary-accent hover:text-text-heading flex items-center gap-1 transition-colors"
                >
      ...
      <Card className="border-border">
        <CardContent className="p-6">
          <h2 className="text-2xl font-bold text-text-heading mb-4">League Coverage</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={item.league} className="p-3 bg-surface-hover rounded-lg text-center">
                <p className="font-semibold text-text-heading">{item.league}</p>
                <p className="text-xs text-text-body">{item.description}</p>
              </div>
            ))}
          </div>
        </CardContent>
